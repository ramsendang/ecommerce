...
<div class="ht__bradcaump__area"
            style="background: rgba(0, 0, 0, 0) url(images/cover.jpeg) no-repeat scroll center center / cover ;">
                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner">
                                    ...
                                    <a class="breadcrumb-item" href="categories.php?id=echo $get_product[0]['categories_id']"><?php echo $get_product[0]['categories']?></a>
                                    <span class="brd-separetor"><i class="zmdi zmdi-chevron-right"></i></span>
                        ...
                        <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12 smt-40 xmt-40">
                            <div class="ht__product__dtl">
                                ...
                                <div class="ht__pro__desc">
                                    ...
                                    <a class="fr__btn" href="javascript:void(0)" onclick="manageCart('<?php echo $get_product[0]['id']?>','add')">add to cart</a>
                                </div>
                            </div>
                        </div>
                    </div>
