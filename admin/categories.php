...
if(isset($_GET['type']) && $_GET['type']!=''){
    ...
    if($type == 'status'){
        ...
        $update_staus_sql = "UPDATE categories SET status = '$status' WHERE id = '$id'";
        mysqli_query($conn, $update_staus_sql);
    }
    if($type == 'delete'){
        $id = get_safe_value($conn, $_GET['id']);
        $delete_staus_sql = "DELETE FROM categories WHERE id = '$id'";
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                                ...
                                                echo "&nbsp&nbsp&nbsp&nbsp<span class='badge badge-edit' ><a href='manage_categories.php?id=".$row['id']."' style='color: black'>Edit&nbsp&nbsp</a></span>";
