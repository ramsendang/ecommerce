                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <br>
                                            <a href="javascript:void(0)" onclick="manageCart('<?php echo $key?>','update')">update</a>
                                            </td>
                                            <td class="product-subtotal">£<?php echo $price*$qty?></td>
                                            <td class="product-remove"><a href="javascript:void(0)" onclick="manageCart('<?php echo $key?>','remove')"><i class="icon-trash icons"></i></a></td>
                                        </tr>
                                        <?php
                                        } }?>
